  ...
  template: `
    ...
    >
      <div class="max-w-2xl mx-auto px-5">
        ...
        <p
          class="text-sm font-light mb-10"
          ...
          <div class="flex justify-center gap-8 mb-8">
            ...
            >
              ...
              <span
                ...
                [style.border-color]="
                  formData.attendance === 'yes' ? 'var(--color-gold)' : '#ccc'
                "
              >
                <span
            ...
            >
              ...
              <span
                class="w-5 h-5 border-2 rounded-full mr-2 relative flex items-center justify-center transition-colors"
                [style.border-color]="
                  formData.attendance === 'no' ? 'var(--color-gold)' : '#ccc'
                "
              >
                <span
            ...
            <div class="flex justify-center gap-8">
              ...
              >
                ...
                <span
                  class="w-5 h-5 border-2 rounded-full mr-2 relative flex items-center justify-center transition-colors"
                  [style.border-color]="
                    formData.companion === 'yes' ? 'var(--color-gold)' : '#ccc'
                  "
                >
    ...
    @if (viewModal) {
      ...
      >
        <div
          class="bg-white rounded-2xl w-full max-w-md mx-4 p-6 relative"
