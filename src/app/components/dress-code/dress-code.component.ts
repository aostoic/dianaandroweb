  ...
  template: `
    ...
    >
      <div class="max-w-2xl mx-auto px-5">
        ...
        >
          <span class="material-icons text-3xl" style="color: var(--color-gold)"> checkroom </span>
        </div>
        ...
        <p class="text-lg font-light mb-1" style="color: var(--color-text)">Elegante</p>
        <p class="text-xs font-light mb-0" style="color: var(--color-text-light)">Vestimenta formal o semi-formal</p>
        ...
        <div class="warning-box inline-flex items-center gap-2 mx-auto">
          <span class="material-icons" style="color: #b04040; font-size: 18px">block</span>
