  ...
  template: `
    ...
    >
      ...
      <div class="z-10 pt-24 mb-auto hero-fade-in">
        <p
          class="text-sm tracking-[0.3em] uppercase font-light mb-3 opacity-90"
        >
          Nos casamos
        </p>
        <h1 class="mb-2 drop-shadow-lg text-white" style="color: #fff">
          Andro & Diana
        </h1>
        <p class="text-lg font-light tracking-wider opacity-90">
          04 . 04 . 2026
        </p>
        <div class="mt-8">
      ...
      <div class="z-10 pb-14 mt-auto hero-fade-in-delayed">
        ...
        <p
          class="text-base md:text-lg font-light max-w-md mx-auto px-4 opacity-90"
        >
